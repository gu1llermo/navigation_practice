...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: TweenAnimationScreen.path,
      builder: (context, state) => const TweenAnimationScreen(),
    ),
    GoRoute(
      path: TweenAnimation01.path,
      builder: (context, state) => const TweenAnimation01(),
    ),
    GoRoute(
      path: TweenAnimation02.path,
      builder: (context, state) => const TweenAnimation02(),
    ),
    GoRoute(
      path: TweenAnimation03.path,
      builder: (context, state) => const TweenAnimation03(),
    ),
  ],
);
